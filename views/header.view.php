        ...
        <div class="container-fluid collapse h-100 menu" id="navbarToggleExternalContent">
            <div class="row align-items-center h-100">
                <div class='col'>
                    ...
                    <button class="navbar-toggler menu-close" type="button" data-toggle="collapse"
                        data-target="#navbarToggleExternalContent" aria-controls="navbarSupportedContent"
                    ...
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link nav-link-about" href="https://medium.com/@am_jedidiah">Stories</a>
                        </li>
                        <li class="nav-item">
...
>>>>>>> 62d9687c0842ad387bbb40f74a71ee84510ee34b
            <a class="nav-link" href="?p=diary">Diary</a>
                    ...
                    <div class='social'>
                        <a href='https://www.linkedin.com/in/am-jedidiah/' data-toggle="tooltip"
                            title="LinkedIn Profile"><span class='fab fa-linkedin-in'></span></a>
                        <a href='https://github.com/amjedidiah'><span class="fab fa-github"></span></a>
                        <a href='https://medium.com/@am_jedidiah'><span class="fab fa-medium"></span></a>
        ...
        <div class="container-fluid collapse h-100 form" id="requestToggle">
            <div class="row align-items-center h-100">
                <div class='col' id='wittr-2'>
                    ...
                    <button class="navbar-toggler form-close" type="button" data-toggle="collapse"
                        data-target="#requestToggle" aria-controls="navbarSupportedContent" aria-expanded="false"
...
<<<<<<< HEAD
        <nav class="navbar navbar-light fixed-top" id='header'>
            <a class="navbar-brand" href="<?php
                                    ...
                                    ?>">aj</a>
            <button class="d-none d-md-block navbar-toggler menu-open" type="button" data-toggle="collapse"
                data-target="#navbarToggleExternalContent" aria-controls="navbarSupportedContent" aria-expanded="false"
                aria-label="Toggle navigation" data-toggle="tooltip" title="Menu">
                <span class='fa fa-ellipsis-h'></span>
            </button>
            <button class="d-md-none navbar-toggler menu-open" type="button" data-toggle="collapse"
                data-target="#navbarToggleExternalContent" aria-controls="navbarSupportedContent" aria-expanded="false"
                aria-label="Toggle navigation">
                MENU
            </button>
