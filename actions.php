<?php
    ...
    if(isset($_POST['name'], $_POST['email'], $_POST['option'])) {
        $name = $_POST['name'];
        $email = $_POST['email'];
        $option = $_POST['option'];
        
        $result = $mg->messages()->send(DOMAIN_NAME, [
            'from'    => 'Portfolio Site <hello@sandboxc5c8b63482db4ceaa508576156070083.mailgun.org>',
